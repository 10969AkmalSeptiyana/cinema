        ...
        <div className="flex flex-col-reverse gap-y-8 mt-10 md:flex-row xl:mx-auto">
          ...
          <div className="max-w-[350px]">
            <div className="flex gap-x-5">
              <div className="w-28 h-4 bg-gray-400 animate-pulse rounded-full"></div>
              <div className="w-20 h-4 bg-gray-400 animate-pulse rounded-full"></div>
            </div>
            <div className="w-full h-4 mt-6 bg-gray-400 animate-pulse rounded-full"></div>
            <div className="w-full h-4 mt-6 bg-gray-400 animate-pulse rounded-full"></div>
            <div className="w-full h-4 mt-6 bg-gray-400 animate-pulse rounded-full"></div>
            <div className="w-full h-4 mt-6 bg-gray-400 animate-pulse rounded-full"></div>
          </div>
